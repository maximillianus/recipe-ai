    ...
    <main className="flex min-h-screen flex-col items-center  p-24  m-auto ">
      <div className=" pb-10 mx-auto text-center flex flex-col items-start -center max-w-3xl">
        <h1 className=" text-4xl  font-bold  text-gray-900 sm:text-6xl ">
          "Gen AI Masterchef" bersama <span className=" text-blue-600"> Chef AWnold </span>
          <p className=" mt-10 font-medium   text-lg  max-w-prose text-gray-900 ">
            Silakan tulis bahan-bahan yang kamu miliki seperti telur, cabe, bawang merah, ayam, dsb.
            dan Chef AWnold akan menyarankan makanan yang paling pas serta berbagai resepnya!
          </p>
        </h1>
      </div>
      ...
      <section className="   w-1/2  mx-auto ">
        ...
        >
          <input
            ...
            name="ingredients"
            required
            placeholder="Bahan 1, Bahan 2, Bahan 3,..dst"
